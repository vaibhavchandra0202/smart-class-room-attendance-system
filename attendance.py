...
logo = Image.open("UI_Image/GLA_University_logo.png")
...
titl = tk.Label(
    window, text="G.L.A University ", bg="black", fg="green", font=("arial", 27),
)
titl.place(x=750, y=12)

a = tk.Label(
    window,
    text="Smart Classroom Attendance System",
    bg="White",
    fg="Black",
    bd=10,
    font=("arial", 35),
...
label2.image = a
label2.place(x=1480, y=270)

vi = Image.open("UI_Image/verifyy.png")
v = ImageTk.PhotoImage(vi)
label3 = Label(window, image=v)
label3.image = v
label3.place(x=850, y=270)
